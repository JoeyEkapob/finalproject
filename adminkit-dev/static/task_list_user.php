                            ...
                            <table class="table table-hover my-0" id="example">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $where = "";    
                                        if($level >= 3 ){
                                            $where = " where user_id  = '{$_SESSION['user_login']}'"  ;
                                            
                                        }
                                        $stmtprotasklist = "SELECT * FROM project natural join project_list natural join task_list natural join user $where order by end_date  DESC ";
                                    ...
                                    <td class="text-center">
                                      ...
                                      <?php if($stmtprotasklistrow['manager_id'] == $user_id || $level <= 2 || $stmtprotasklistrow['user_id'] == $user_id ){?>
