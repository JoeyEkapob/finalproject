                                        ...
                                        <tr class="id-col">
                                            ...
                                            <td class="text-center">                   
                                               <!--  <a class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#exampleModal">1</a>    -->                      
                                                ...
                                                <button class="btn btn-success btn-sm checktasksuccess" title="งานเสร็จสิ้น" data-details_id="<?php echo $row['details_id'] ?>" data-task_id="<?php echo $row['task_id'] ?>" data-project_id="<?php echo $row['project_id'] ?>"> <i data-feather="check-square"></i></button>
