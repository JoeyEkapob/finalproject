 ...
 */        
        ...
        $numtask = $db->query("SELECT DISTINCT task_id FROM task_list as t 
        LEFT JOIN project_list AS pl ON t.project_id  = pl.project_id 
...
else if($_POST['proc']== 'reportuserprocreate'){
